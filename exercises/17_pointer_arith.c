...
int main(void)
{
    ...
    /* TODO: the int p points at */
    printf("*p is %d\n", 0);

    /* TODO: the int one element past p */
    printf("*(p + 1) is %d\n", 0);

    /* TODO: the int three elements past p */
    printf("*(p + 3) is %d\n", 0);

    /* TODO: the distance in BYTES between p and p + 1.
             Cast both pointers to (char *) and subtract. */
